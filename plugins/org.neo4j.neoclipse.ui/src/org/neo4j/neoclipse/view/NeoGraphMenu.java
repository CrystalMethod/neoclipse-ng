...
public class NeoGraphMenu {
    ...
    private final MenuManager addLoopMenuMgr = new MenuManager(Actions.ADD_LOOP.label(), Actions.ADD_LOOP.icon()
            .descriptor(), "addLoopSubmenu");
    private static final MenuManager addLoopMenuMgrFake = new MenuManager(Actions.ADD_LOOP.label(), Actions.ADD_LOOP
            .disabledIcon().descriptor(), "addLoopSubmenuFake");
    /**
     ...
     * @param out
     *            enable add outgoing relationships
     * @param in
    ...
    private void makeContributions() {
        ...
        // printing
        graphView.getViewSite().getActionBars()
                .setGlobalActionHandler(ActionFactory.PRINT.getId(), new PrintGraphAction(graphView));
    }
    ...
    private void contributeLayoutActions(final IToolBarManager tm, final IMenuManager mm) {
        {
            ...
            ShowHorizontalShiftLayoutAction horizontalShiftLayoutAction = new ShowHorizontalShiftLayoutAction(graphView);
